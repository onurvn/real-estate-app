  ...
  return (
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form className="flex flex-col sm:flex-row gap-4">
        <div className="flex text-black flex-col gap-4 flex-1">
          <input
            type="text"
            placeholder="Name"
          ...
          <div className="flex text-white flex-wrap gap-6">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            <input
              ...
              multiple
            />
            <button className="p-3 border rounded disabled:opacity-80">
              Upload Image
            </button>
          </div>
