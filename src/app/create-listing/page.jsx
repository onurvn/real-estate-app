        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="p-3 border rounded uppercase hover:bg-white hover:text-black hover:shadow-lg disabled:opacity-80"
            >
          ...
          <button
            className="p-3 border hover:bg-white hover:text-black rounded-lg  hover:opacity-95 disabled:opacity-80"
